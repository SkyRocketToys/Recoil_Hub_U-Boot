 ...
 */
	...
	#define CONFIG_QCA_GPIO_MASK_OUT	GPIO6 | CONFIG_QCA_GPIO_MASK_LED_ACT_H
	#define CONFIG_QCA_GPIO_MASK_IN		GPIO1  | GPIO7  | GPIO8 | GPIO11 | GPIO14 | GPIO16 | GPIO17
...
#elif defined(CONFIG_FOR_OPENEMBED_SOM9331)

	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L	GPIO27
	#define CONFIG_QCA_GPIO_MASK_OUT		CONFIG_QCA_GPIO_MASK_LED_ACT_L
	#define CONFIG_QCA_GPIO_MASK_IN			GPIO0 | GPIO1 | GPIO13 | GPIO14 | GPIO15 | GPIO16 | GPIO17
	#define CONFIG_QCA_GPIO_MASK_OUT_INIT_H	CONFIG_QCA_GPIO_MASK_LED_ACT_L
...
#elif defined(CONFIG_FOR_GS_OOLITE_V1_DEV) || defined (CONFIG_FOR_OPENEMBED_SOM9331)
 ...
 */
    ...
    !defined(CONFIG_FOR_MESH_POTATO_V2)			&&\
	!defined(CONFIG_FOR_OPENEMBED_SOM9331)
